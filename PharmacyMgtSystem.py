    ...
    def __init__(self, root, root2):
        ...
        def DisplayData():
            ...
            for row in Database.viewData():
                ...
                # -1 because I am reading the medicines that are there in the cart but also have to account for the
                # current selection, which is about to be added. Which means I am evaluating the Quantity that would be
        ...
        DataFrameLEFT = LabelFrame(DataFrame, bd=1, width=450, height=300, padx=31,pady=3, relief=RIDGE, font=('arial', 20, 'bold'), bg="Ghost White", text="List of Medicines:", fg="black")
        DataFrameLEFT.pack(side=LEFT)

        DataFrameRIGHT = LabelFrame(DataFrame, bd=1, width=450, height=300, padx=31, pady=3, relief=RIDGE, font=('arial', 20, 'bold'), bg="Ghost White", text="Cart:", fg="black")
